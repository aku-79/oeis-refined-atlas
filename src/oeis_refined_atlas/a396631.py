"""A396631: the (D, sym) class of the refined bracelet atlas."""
...
TERMS: List[int] = [0, 0, 0, 0, 0, 1, 0, 4, 1, 22, 0, 130]


def term(n: int) -> int:
    """Return a(n) for A396631."""

    if 1 <= n <= len(TERMS):
        return TERMS[n - 1]
    return refined_dihedral_counts_for_n(n)[("D", "sym")]
