"""Self-contained program for OEIS A396631.

A396631 is the (D, sym) class of the refined bracelet atlas over integer
...
KNOWN_TERMS = [0, 0, 0, 0, 0, 1, 0, 4, 1, 22, 0, 130]
...
def computed_term(n):
    return cyclic_to_dihedral(refined_cyclic_counts(n))[("D", "sym")]
