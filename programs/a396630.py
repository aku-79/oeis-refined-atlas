"""Self-contained program for OEIS A396630.

A396630 is the (D, ns) class of the refined bracelet atlas over integer
...
KNOWN_TERMS = [0, 0, 1, 4, 22, 125, 809, 5929, 48336, 443762, 4469217, 49647760]
...
def computed_term(n):
    return cyclic_to_dihedral(refined_cyclic_counts(n))[("D", "ns")]
