...
A395436 is the (S1, ns) class of the refined bracelet atlas over integer
...
KNOWN_TERMS = [0, 0, 1, 0, 5, 0, 22, 0, 108, 0, 616, 0]
...
def computed_term(n):
    if n < 3:
        return 0
    return cyclic_to_dihedral(refined_cyclic_counts(n))[("S1", "ns")]
